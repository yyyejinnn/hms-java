...
public class Room {                             //객실 클래스
    /*
    private boolean reservationRoom;		//현재예약된 방인지 아닌
    private boolean clean;                      //고객체크아웃이후에 청소된방인지아닌지
    private boolean usingRoom;                  //고객 체크인하면 true 체크아웃하면 false
    private int maxPeopleNum;                   //최대수용인원
    ...
    public int roomState() {
    		...
    		System.out.println("---------------------------");
    		System.out.println("1. 객실금액 변경");
    		System.out.println("2. 청소여부 변경");
    		System.out.println("3. 체크인 여부 변경");
    		System.out.println("4. 최대수용인원 변경");
    		System.out.println("5. 객실요금 변경");
    		System.out.println("7. 객실관리시스템 종료(메인메뉴화면으로)");
    		System.out.println("---------------------------");
    ...
    public void setClean(boolean clean) {           //청소된 객실인지 아닌지 변경
        this.clean = clean;
    }
